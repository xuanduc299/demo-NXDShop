        ...
        <div class="ps-products-wrap pt-80 pb-80">
          <div class="ps-products" data-mh="product-listing">
            ...
            <div class="ps-product__columns">
                ...
                <div class="ps-shoe mb-30">
                  <div class="ps-shoe__thumbnail">
                    ...
                    <div class="ps-badge ps-badge--sale ps-badge--2nd"><span>-35%</span></div><a
                      class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="../images/shoe/1.jpg"
                      alt=""><a class="ps-shoe__overlay" href="product-detail.jsp"></a>
                  </div>
              ...
              <div class="ps-product__column">
                <div class="ps-shoe mb-30">
                  <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i
                        class="ps-icon-heart"></i></a><img src="../images/shoe/2.jpg" alt=""><a class="ps-shoe__overlay"
              ...
              <div class="ps-product__column">
                <div class="ps-shoe mb-30">
                  <div class="ps-shoe__thumbnail">
                    <div class="ps-badge ps-badge--sale"><span>-35%</span></div><a class="ps-shoe__favorite" href="#"><i
              ...
              <div class="ps-product__column">
                <div class="ps-shoe mb-30">
                  <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i
                        class="ps-icon-heart"></i></a><img src="../images/shoe/7.jpg" alt=""><a class="ps-shoe__overlay"
                      href="product-detail.jsp"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
              ...
              <div class="ps-product__column">
                <div class="ps-shoe mb-30">
                  <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i
                        class="ps-icon-heart"></i></a><img src="../images/shoe/8.jpg" alt=""><a class="ps-shoe__overlay"
                      href="product-detail.jsp"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
              ...
              <div class="ps-product__column">
                <div class="ps-shoe mb-30">
                  <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i
                        class="ps-icon-heart"></i></a><img src="../images/shoe/9.jpg" alt=""><a class="ps-shoe__overlay"
                      href="product-detail.jsp"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
              ...
              <div class="ps-product__column">
                <div class="ps-shoe mb-30">
                  <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i
                        class="ps-icon-heart"></i></a><img src="../images/shoe/10.jpg" alt=""><a class="ps-shoe__overlay"
                      href="product-detail.jsp"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
          ...
          <div class="ps-sidebar" data-mh="product-listing">
            <aside class="ps-widget--sidebar ps-widget--category">
              ...
              <div class="ps-widget__content">
                <ul class="ps-list--checked">
                  <li class="current"><a href="../../views/product-listing.jsp">Life(521)</a></li>
                  <li><a href="../../views/product-listing.jsp">Running(76)</a></li>
                  <li><a href="../../views/product-listing.jsp">Baseball(21)</a></li>
                  <li><a href="../../views/product-listing.jsp">Football(105)</a></li>
                  <li><a href="../../views/product-listing.jsp">Soccer(108)</a></li>
                  <li><a href="../../views/product-listing.jsp">Trainning & game(47)</a></li>
                  <li><a href="../../views/product-listing.jsp">More</a></li>
                </ul>
              </div>
            </aside>
            ...
            <aside class="ps-widget--sidebar ps-widget--category">
              ...
              <div class="ps-widget__content">
                <ul class="ps-list--checked">
                  <li class="current"><a href="../../views/product-listing.jsp">Nike(521)</a></li>
                  <li><a href="../../views/product-listing.jsp">Adidas(76)</a></li>
                  <li><a href="../../views/product-listing.jsp">Baseball(69)</a></li>
                  <li><a href="../../views/product-listing.jsp">Gucci(36)</a></li>
                  <li><a href="../../views/product-listing.jsp">Dior(108)</a></li>
                  <li><a href="../../views/product-listing.jsp">B&G(108)</a></li>
                  <li><a href="../../views/product-listing.jsp">Louis Vuiton(47)</a></li>
                </ul>
              </div>
            </aside>
            <aside class="ps-widget--sidebar ps-widget--category">
              ...
              <div class="ps-widget__content">
                <ul class="ps-list--checked">
                  <li class="current"><a href="../../views/product-listing.jsp">Narrow</a></li>
                  <li><a href="../../views/product-listing.jsp">Regular</a></li>
                  <li><a href="../../views/product-listing.jsp">Wide</a></li>
                  <li><a href="../../views/product-listing.jsp">Extra Wide</a></li>
                </ul>
              </div>
            </aside>
