            ...
            <div class="ps-section__content">
              <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 "><a class="ps-offer mb-30"
                    href="product-detail.jsp"><img src="images/offer/home-3-1.jpg" alt=""></a><a class="ps-offer"
                    href="product-detail.jsp"><img src="images/offer/home-3-3.jpg" alt=""></a>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 "><a class="ps-offer" href="product-detail.jsp"><img
                      src="images/offer/home-3-2.jpg" alt=""></a>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="ps-masonry">
                      ...
                      <div class="ps-shoe mb-30">
                        <div class="ps-shoe__thumbnail">
                          ...
                          <div class="ps-badge ps-badge--sale ps-badge--2nd"><span>-35%</span></div><a
                            ...
                            src="images/access/1.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.jsp"></a>
                        </div>
                        <div class="ps-shoe__content">
                          <div class="ps-shoe__variants">
                            <div class="ps-shoe__variant normal"><img src="images/access/1.jpg" alt=""><img
                                src="images/access/2.jpg" alt=""><img src="images/access/3.jpg" alt=""><img
                                src="images/access/4.jpg" alt=""></div>
                    ...
                    <div class="grid-item__content-wrapper">
                      <div class="ps-shoe mb-30">
                        <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i
                              class="ps-icon-heart"></i></a><img src="images/access/2.jpg" alt=""><a
                  ...
                  <div class="grid-item adidas">
                    <div class="grid-item__content-wrapper">
                      <div class="ps-shoe mb-30">
                        <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i
                              class="ps-icon-heart"></i></a><img src="images/access/3.jpg" alt=""><a
                            class="ps-shoe__overlay" href="product-detail.jsp"></a>
                        </div>
                        <div class="ps-shoe__content">
                          <div class="ps-shoe__variants">
                      ...
                      <div class="ps-shoe mb-30">
                        <div class="ps-shoe__thumbnail">
                          <div class="ps-badge ps-badge--sale"><span>-35%</span></div><a class="ps-shoe__favorite"
                            href="#"><i class="ps-icon-heart"></i></a><img src="images/access/4.jpg" alt=""><a
                            class="ps-shoe__overlay" href="product-detail.jsp"></a>
                        </div>
                        <div class="ps-shoe__content">
                          <div class="ps-shoe__variants">
                  ...
                  <div class="grid-item men">
                    <div class="grid-item__content-wrapper">
                      <div class="ps-shoe mb-30">
                        <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i
                              class="ps-icon-heart"></i></a><img src="images/access/5.jpg" alt=""><a
                            class="ps-shoe__overlay" href="product-detail.jsp"></a>
                        </div>
                        <div class="ps-shoe__content">
                          <div class="ps-shoe__variants">
                  ...
                  <div class="grid-item women">
                    <div class="grid-item__content-wrapper">
                      <div class="ps-shoe mb-30">
                        <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i
                              class="ps-icon-heart"></i></a><img src="images/access/6.jpg" alt=""><a
                            class="ps-shoe__overlay" href="product-detail.jsp"></a>
                        </div>
                        <div class="ps-shoe__content">
                          <div class="ps-shoe__variants">
                  ...
                  <div class="grid-item kids">
                    <div class="grid-item__content-wrapper">
                      <div class="ps-shoe mb-30">
                        <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i
                              class="ps-icon-heart"></i></a><img src="images/access/7.jpg" alt=""><a
                            class="ps-shoe__overlay" href="product-detail.jsp"></a>
                        </div>
                        <div class="ps-shoe__content">
                          <div class="ps-shoe__variants">
                  ...
                  <div class="grid-item kids">
                    <div class="grid-item__content-wrapper">
                      <div class="ps-shoe mb-30">
                        <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i
                              class="ps-icon-heart"></i></a><img src="images/access/8.jpg" alt=""><a
                            class="ps-shoe__overlay" href="product-detail.jsp"></a>
                        </div>
                        <div class="ps-shoe__content">
                          <div class="ps-shoe__variants">
          ...
          <div class="ps-container">
            ...
            <div class="ps-section__content">
              <div class="ps-owl--colection owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000"
                ...
                data-owl-item-sm="2" data-owl-item-md="2" data-owl-item-lg="4" data-owl-duration="1000"
                data-owl-mousedrag="on">
                <div class="ps-shoes--carousel">
                  <div class="ps-shoe">
                    <div class="ps-shoe__thumbnail">
                      <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i
                          class="ps-icon-heart"></i></a><img src="images/access/1.jpg" alt="">
                    </div>
                    <div class="ps-shoe__content">
                      <div class="ps-shoe__variants">
                        <div class="ps-shoe__variant normal"><img src="images/access/2.jpg" alt=""><img
                            src="images/access/3.jpg" alt=""><img src="images/access/4.jpg" alt=""><img
                            src="images/access/5.jpg" alt=""></div>
                        <select class="ps-rating ps-shoe__rating">
                          <option value="1">1</option>
                          <option value="1">2</option>
                ...
                <div class="ps-shoes--carousel">
                  <div class="ps-shoe">
                    <div class="ps-shoe__thumbnail">
                      <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i
                          class="ps-icon-heart"></i></a><img src="images/access/3.jpg" alt="">
                    </div>
                    <div class="ps-shoe__content">
                      <div class="ps-shoe__variants">
                        <div class="ps-shoe__variant normal"><img src="images/access/2.jpg" alt=""><img
                ...
                <div class="ps-shoes--carousel">
                  <div class="ps-shoe">
                    <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i
                          class="ps-icon-heart"></i></a><img src="images/access/4.jpg" alt="">
                    </div>
                    <div class="ps-shoe__content">
                      <div class="ps-shoe__variants">
                        <div class="ps-shoe__variant normal"><img src="images/access/2.jpg" alt=""><img
                ...
                <div class="ps-shoes--carousel">
                  <div class="ps-shoe">
                    <div class="ps-shoe__thumbnail">
                      <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i
                          class="ps-icon-heart"></i></a><img src="images/access/5.jpg" alt="">
                    </div>
                    <div class="ps-shoe__content">
                      <div class="ps-shoe__variants">
                        <div class="ps-shoe__variant normal"><img src="images/access/2.jpg" alt=""><img
                ...
                <div class="ps-shoes--carousel">
                  <div class="ps-shoe">
                    <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i
                          class="ps-icon-heart"></i></a><img src="images/access/6.jpg" alt="">
                    </div>
                    <div class="ps-shoe__content">
                      <div class="ps-shoe__variants">
                        <div class="ps-shoe__variant normal"><img src="images/access/2.jpg" alt=""><img
            ...
            <div class="ps-section__content">
              <div class="row">
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 ">
                  <div class="ps-product--hotdeal reverse">
                    ...
                    <div class="ps-product__content"><a class="ps-product__title text-uppercase"
                        href="product-detail.jsp">Jordan pro andre hat</a>
                      <p class="ps-product__price">Only: <span>Â£178</span></p>
                      <div class="ps-product__status">
                        <div class="sold">Already sold: <span>10</span></div>
                        <div class="avaiable">Avaiable: <span>30</span></div>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 ">
                  <div class="ps-product--hotdeal reverse">
                    <div class="ps-product__thumbnail"><a class="ps-product__overlay" href="product-detail.jsp"></a><img
                        src="images/access/1.jpg" alt=""></div>
                    <div class="ps-product__content"><a class="ps-product__title text-uppercase"
                        href="product-detail.jsp">brasilia small bag</a>
                      <p class="ps-product__price">Only: <span>Â£178</span></p>
                      <div class="ps-product__status">
                        <div class="sold">Already sold: <span>10</span></div>
                        <div class="avaiable">Avaiable: <span>30</span></div>
