				...
				<div class="navigation__column center">
					<ul class="main-menu menu">
								...
								<div class="mega-wrap">
									<div class="mega-column">
										<ul class="mega-item mega-features">
											...
											<li><a href="product-listing.jsp">MOTHER'S DAY
													COLLECTION</a></li>
						...
						<li class="menu-item menu-item-has-children dropdown"><a
							...
							<ul class="sub-menu">
								<li class="menu-item menu-item-has-children dropdown"><a
									...
									<ul class="sub-menu">
										<li class="menu-item"><a href="blog-grid.jsp">Blog
												Grid 1</a></li>
										<li class="menu-item"><a href="blog-grid-2.jsp">Blog
												Grid 2</a></li>
									</ul></li>
						...
						<li class="menu-item menu-item-has-children dropdown"><a
							href="#">Contact</a>
							<ul class="sub-menu">
								<li class="menu-item"><a href="contact-us.jsp">Contact
										Us #1</a></li>
								<li class="menu-item"><a href="contact-us.jsp">Contact
										Us #2</a></li>
							</ul></li>
				...
				<div class="row">
					<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 ">
						<div class="ps-post--detail">
							<div class="ps-post__thumbnail">
								<img src="images/blog/11.png" alt="">
							</div>
							<div class="ps-post__header">
								<h3 class="ps-post__title">Unpacking the Breaking 2 Race
									Strategy</h3>
								<p class="ps-post__meta">
									Posted by <a href="blog-grid.jsp">Alena Studio</a> on August
									17, 2016 in <a href="blog-grid.jsp">Men Shoes</a> , <a
										href="blog-grid.jsp">Stylish</a>
								</p>
							</div>
							<div class="ps-post__content">
								<p>No matter how far along you are in your sophistication as
									an amateur astronomer, there is always one fundamental moment
									that we all go back to. That is that very first moment that we
									went out where you could really see the cosmos well and you
									took in the night sky. For city dwellers, this is a revelation
									as profound as if we discovered aliens living among us. Most of
									us have no idea the vast panorama of lights that dot a clear
									night sky when there are no city lights to interfere with the
									view.</p>
								<blockquote>
									<p>It seems from the moment you begin to take your love of
										astronomy seriously, the thing that is on your mind is what
										kind of telescope will you get. And there is no question,
										investing in a good telescope can really enhance your
										enjoyment of your new passion in astronomy.</p>
									<p class="author">
										Rodney <br> <span>Cannon</span>
									</p>
								</blockquote>
								<p>In the history of modern astronomy, there is probably no
									one greater leap forward than the building and launch of the
									space telescope known as the Hubble. While NASA has had many
									ups and downs, the launch and continued operation of the Hubble
									space telescope probably ranks next to the moon landings ace
									exploration accomplishments of the last hundred years.</p>
							</div>
							<div class="ps-post__footer">
								<p class="ps-post__tags">
									<i class="fa fa-tags"></i><a href="blog-list.jsp">Man shoe</a>,<a
										href="blog-list.jsp"> Woman</a>,<a href="blog-list.jsp">
										Nike</a>
								</p>
								<div class="ps-post__actions">
									<span><i class="fa fa-comments"></i> 23 Comments</span><span><i
										class="fa fa-heart"></i> likes</span>
						...
						<div class="ps-author">
							...
							<div class="ps-author__content">
								...
								<p>The development of the mass spectrometer allowed the mass
									of atoms to be measured with increased accuracy. The device
									uses the launch and continued operation of the Hubble space
									telescope probably.</p>
							</div>
						</div>
						<div class="ps-comments">
							...
							<div class="ps-comment">
								...
								<div class="ps-comment__content">
									<header>
										<h4>
											MARK GREY <span>(15 minutes ago)</span>
										</h4>
										<a href="#">Reply<i class="ps-icon-arrow-left"></i></a>
									</header>
									<p>The development of the mass spectrometer allowed the
										mass of atoms to be measured with increased accuracy. The
										device uses the launch and continued operation of the Hubble
										space telescope probably.</p>
								</div>
							</div>
							<div class="ps-comment ps-comment--reply">
								...
								<div class="ps-comment__content">
									<header>
										<h4>
											MARK GREY <span>(3 hours ago)</span>
										</h4>
										<a href="#">Reply<i class="ps-icon-arrow-left"></i></a>
									</header>
									<p>The development of the mass spectrometer allowed the
										mass of atoms to be measured with increased accuracy. The
										device uses continue ace explore.</p>
								</div>
							</div>
							<div class="ps-comment">
								<div class="ps-comment__thumbnail">
					...
					<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
						...
						<aside class="ps-widget--sidebar">
							...
							<div class="ps-widget__content">
								<ul class="ps-list--arrow">
									<li class="current"><a href="product-listing.jsp">Sky(321)</a></li>
									<li><a href="product-listing.jsp">Amazinâ Glazinâ</a></li>
									<li><a href="product-listing.jsp">The Crusty Croissant</a></li>
									<li><a href="product-listing.jsp">The Rolling Pin</a></li>
									<li><a href="product-listing.jsp">Skippity Scones</a></li>
									<li><a href="product-listing.jsp">Mad Batter</a></li>
									<li><a href="product-listing.jsp">Confection
											Connection</a></li>
								</ul>
							</div>
						</aside>
						<aside class="ps-widget--sidebar">
							...
							<div class="ps-widget__content">
								<a href="product-listing"><img
									src="images/offer/sidebar.jpg" alt=""></a>
							</div>
						</aside>
						<aside class="ps-widget--sidebar">
							<div class="ps-widget__header">
							...
							<div class="ps-widget__content">
								<div class="ps-post--sidebar">
									<div class="ps-post__thumbnail">
										<a href="#"></a><img src="images/blog/sidebar/1.jpg" alt="">
									</div>
									<div class="ps-post__content">
										<a class="ps-post__title" href="#">Micenas Placerat Nibh
											Loreming Fentum</a><span>SEP 29, 2017</span>
									</div>
								</div>
								<div class="ps-post--sidebar">
									<div class="ps-post__thumbnail">
										<a href="#"></a><img src="images/blog/sidebar/2.jpg" alt="">
									</div>
									<div class="ps-post__content">
										<a class="ps-post__title" href="#">Micenas Placerat Nibh
											Loreming Fentum</a><span>SEP 29, 2017</span>
								...
								<div class="ps-post--sidebar">
									<div class="ps-post__thumbnail">
										<a href="#"></a><img src="images/blog/sidebar/3.jpg" alt="">
									</div>
									<div class="ps-post__content">
										<a class="ps-post__title" href="#">Micenas Placerat Nibh
											Loreming Fentum</a><span>SEP 29, 2017</span>
							...
							<div class="ps-widget__content">
								<div class="ps-shoe--sidebar">
									<div class="ps-shoe__thumbnail">
										<a href="#"></a><img src="images/shoe/sidebar/1.jpg" alt="">
									</div>
									<div class="ps-shoe__content">
										<a class="ps-shoe__title" href="#">Men's Sky</a>
										<p>
											<del> Â£253.00</del>
											Â£152.00
										</p>
								...
								<div class="ps-shoe--sidebar">
									<div class="ps-shoe__thumbnail">
										<a href="#"></a><img src="images/shoe/sidebar/2.jpg" alt="">
									</div>
									<div class="ps-shoe__content">
										<a class="ps-shoe__title" href="#">Nike Flight Bonafide</a>
										<p>
											<del> Â£253.00</del>
											Â£152.00
										</p>
								...
								<div class="ps-shoe--sidebar">
									<div class="ps-shoe__thumbnail">
										<a href="#"></a><img src="images/shoe/sidebar/3.jpg" alt="">
									</div>
									<div class="ps-shoe__content">
										<a class="ps-shoe__title" href="#">Nike Sock Dart QS</a>
										<p>
											<del> Â£253.00</del>
											Â£152.00
										</p>
						...
						<aside class="ps-widget--sidebar">
							...
							<div class="ps-widget__content">
								<ul class="ps-tags">
									<li><a href="product-listing.jsp">Men</a></li>
									<li><a href="product-listing.jsp">Female</a></li>
									<li><a href="product-listing.jsp">B&G</a></li>
									<li><a href="product-listing.jsp">ugly fashion</a></li>
									<li><a href="product-listing.jsp">Nike</a></li>
									<li><a href="product-listing.jsp">Dior</a></li>
									<li><a href="product-listing.jsp">Adidas</a></li>
									<li><a href="product-listing.jsp">Diour</a></li>
								</ul>
							</div>
						</aside>
					</div>
