...
<body class="ps-loading">
	...
	<main class="ps-main">
		<div class="ps-mission bg-cover"
			data-background="images/parallax/home-testimonial.jpg">
			<div class="ps-container">
				<h3>our mission</h3>
				<h2>
					Your success is our ambition. <br /> Your defeat spurs us on to be
					better.
				</h2>
			</div>
		</div>
				...
				<div class="row ps-col-tiny">
					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
						<div class="ps-join-team">
							<h3>Would you like to join team & build your dream NOW?</h3>
							<a class="ps-btn" href="#">JOIN OUR TEAM<i
								class="ps-icon-arrow-left"></i></a>
						</div>
					</div>
				</div>
