        ...
        <div class="ps-products-wrap inverse pt-80 pb-80">
          ...
          <div class="ps-sidebar" data-mh="product-listing">
            <aside class="ps-widget--sidebar ps-widget--category">
              ...
              <div class="ps-widget__content">
                <ul class="ps-list--checked">
                  <li class="current"><a href="product-listing.jsp">Life(521)</a></li>
                  <li><a href="product-listing.jsp">Running(76)</a></li>
                  <li><a href="product-listing.jsp">Baseball(21)</a></li>
                  <li><a href="product-listing.jsp">Football(105)</a></li>
                  <li><a href="product-listing.jsp">Soccer(108)</a></li>
                  <li><a href="product-listing.jsp">Trainning & game(47)</a></li>
                  <li><a href="product-listing.jsp">More</a></li>
                </ul>
              </div>
            </aside>
            ...
            <aside class="ps-widget--sidebar ps-widget--category">
              ...
              <div class="ps-widget__content">
                <ul class="ps-list--checked">
                  <li class="current"><a href="product-listing.jsp">Nike(521)</a></li>
                  <li><a href="product-listing.jsp">Adidas(76)</a></li>
                  <li><a href="product-listing.jsp">Baseball(69)</a></li>
                  <li><a href="product-listing.jsp">Gucci(36)</a></li>
                  <li><a href="product-listing.jsp">Dior(108)</a></li>
                  <li><a href="product-listing.jsp">B&G(108)</a></li>
                  <li><a href="product-listing.jsp">Louis Vuiton(47)</a></li>
                </ul>
              </div>
            </aside>
            <aside class="ps-widget--sidebar ps-widget--category">
              ...
              <div class="ps-widget__content">
                <ul class="ps-list--checked">
                  <li class="current"><a href="product-listing.jsp">Narrow</a></li>
                  <li><a href="product-listing.jsp">Regular</a></li>
                  <li><a href="product-listing.jsp">Wide</a></li>
                  <li><a href="product-listing.jsp">Extra Wide</a></li>
                </ul>
              </div>
            </aside>
