						...
						<div class="header__actions">
							...
							<div class="btn-group ps-dropdown">
								...
								<ul class="dropdown-menu">
									<li><a href="#"><img src="../images/flag/usa.svg"
											alt=""> USD</a></li>
									<li><a href="#"><img
											src="../images/flag/singapore.svg" alt=""> SGD</a></li>
			...
			<div class="container-fluid">
				<div class="navigation__column left">
					<div class="header__logo">
						<a class="ps-logo" href="../../"><img src="../images/logo.png"
							alt=""></a>
					</div>
				</div>
						...
						<li class="menu-item menu-item-has-children dropdown"><a
							...
							<ul class="sub-menu">
								...
								<li class="menu-item"><a href="../../views/homepage-2.jsp">Homepage
										#2</a></li>
								<li class="menu-item"><a href="../../views/homepage-3.jsp">Homepage
										#3</a></li>
							</ul></li>
					...
					<div class="col-lg-10 col-md-12 col-lg-offset-1">
						<div class="ps-product__thumbnail">
							<div class="ps-product__preview">
								...
								<a class="popup-youtube ps-product__video"
									...
									src="../images/shoe-detail/1.jpg" alt=""><i
									class="fa fa-play"></i></a>
							</div>
							<div class="ps-product__image">
								<div class="item">
									<img class="zoom" src="../images/shoe-detail/1.jpg" alt=""
										data-zoom-image="../images/shoe-detail/1.jpg">
								</div>
								<div class="item">
									<img class="zoom" src="../images/shoe-detail/2.jpg" alt=""
										data-zoom-image="../images/shoe-detail/2.jpg">
								</div>
								<div class="item">
									<img class="zoom" src="../images/shoe-detail/3.jpg" alt=""
						...
						<div class="ps-product__thumbnail--mobile">
							...
							<div class="ps-product__preview owl-slider" data-owl-auto="true"
								...
								<img src="../images/shoe-detail/1.jpg" alt=""><img
									src="../images/shoe-detail/2.jpg" alt=""><img
									src="../images/shoe-detail/3.jpg" alt="">
							</div>
						</div>
						<div class="ps-product__info">
							...
							<div class="ps-product__block ps-product__quickview">
								<h4>QUICK REVIEW</h4>
								<p>The Nike Free RN 2017 Men's Running Sky weighs less than
									previous versions and features an updated knit materialâ¦</p>
							</div>
							<div class="ps-product__block ps-product__style">
								<h4>CHOOSE YOUR STYLE</h4>
								<ul>
									<li><a href="../../views/product-detail.jsp"><img
											src="../images/shoe/sidebar/1.jpg" alt=""></a></li>
									<li><a href="../../views/product-detail.jsp"><img
											src="../images/shoe/sidebar/2.jpg" alt=""></a></li>
									<li><a href="../../views/product-detail.jsp"><img
											src="../images/shoe/sidebar/3.jpg" alt=""></a></li>
									<li><a href="../../views/product-detail.jsp"><img
											src="../images/shoe/sidebar/2.jpg" alt=""></a></li>
								</ul>
							</div>
							...
							<div class="ps-product__shopping">
								<a class="ps-btn mb-10" href="cart.jsp">Add to cart<i
									class="ps-icon-next"></i></a>
								<div class="ps-product__actions">
									<a class="mr-10" href="whishlist.jsp"><i
										class="ps-icon-heart"></i></a><a href="compare.jsp"><i
						...
						<div class="tab-content mb-60">
							<div class="tab-pane active" role="tabpanel" id="tab_01">
								<p>Caramels tootsie roll carrot cake sugar plum. Sweet roll
									jelly bear claw liquorice. Gingerbread lollipop dragÃ©e cake.
									Pie topping jelly-o. Fruitcake dragÃ©e candy canes tootsie
									roll. Pastry jelly-o cupcake. Bonbon brownie soufflÃ© muffin.</p>
								<p>Sweet roll soufflÃ© oat cake apple pie croissant. Pie
									...
									bears soufflÃ© candy canes topping gummi bears cake soufflÃ©
									cake. Cotton candy soufflÃ© sugar plum pastry sweet roll..</p>
							</div>
							<div class="tab-pane" role="tabpanel" id="tab_02">
								...
								<div class="ps-review">
									...
									<div class="ps-review__content">
										...
										<p>SoufflÃ© danish gummi bears tart. Pie wafer icing.
											...
											soufflÃ© muffin topping muffin brownie. Tart bear claw cake
				...
				<div class="ps-section__header mb-50">
					<div class="row">
						<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 ">
							<h3 class="ps-section__title" data-mask="Related item">- YOU
								MIGHT ALSO LIKE</h3>
						</div>
					...
					<div class="ps-owl--colection owl-slider" data-owl-auto="true"
							...
							<div class="ps-shoe">
								<div class="ps-shoe__thumbnail">
									...
									<a class="ps-shoe__favorite" href="#"><i
										class="ps-icon-heart"></i></a><img src="../images/shoe/1.jpg"
							...
							<div class="ps-shoe">
								...
								<div class="ps-shoe__content">
									...
									<div class="ps-shoe__detail">
										...
										<span class="ps-shoe__price"> <del>Â£220</del> Â£ 120
										</span>
									</div>
								</div>
							</div>
						...
						<div class="ps-shoes--carousel">
							<div class="ps-shoe">
								<div class="ps-shoe__thumbnail">
									...
									<a class="ps-shoe__favorite" href="#"><i
										class="ps-icon-heart"></i></a><img src="../images/shoe/3.jpg"
										alt=""><a class="ps-shoe__overlay"
										href="../../views/product-detail.jsp"></a>
								</div>
								<div class="ps-shoe__content">
						...
						<div class="ps-shoes--carousel">
							<div class="ps-shoe">
								<div class="ps-shoe__thumbnail">
									<a class="ps-shoe__favorite" href="#"><i
										class="ps-icon-heart"></i></a><img src="../images/shoe/4.jpg"
										alt=""><a class="ps-shoe__overlay"
										href="../../views/product-detail.jsp"></a>
								</div>
								<div class="ps-shoe__content">
						...
						<div class="ps-shoes--carousel">
							<div class="ps-shoe">
								<div class="ps-shoe__thumbnail">
									...
									<a class="ps-shoe__favorite" href="#"><i
										class="ps-icon-heart"></i></a><img src="../images/shoe/5.jpg"
										alt=""><a class="ps-shoe__overlay"
										href="../../views/product-detail.jsp"></a>
								</div>
								<div class="ps-shoe__content">
						...
						<div class="ps-shoes--carousel">
							<div class="ps-shoe">
								<div class="ps-shoe__thumbnail">
									<a class="ps-shoe__favorite" href="#"><i
										class="ps-icon-heart"></i></a><img src="../images/shoe/6.jpg"
										alt=""><a class="ps-shoe__overlay"
										href="../../views/product-detail.jsp"></a>
								</div>
								<div class="ps-shoe__content">
					...
					<div class="row">
						<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
							<aside class="ps-widget--footer ps-widget--info">
								<header>
									<a class="ps-logo" href="../../views/index.jsp"><img
