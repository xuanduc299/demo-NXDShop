              ...
              <ul class="main-menu menu">
                <li class="menu-item menu-item-has-children dropdown"><a href="../../">Home</a>
                  <ul class="sub-menu">
                    ...
                    <li class="menu-item"><a href="../../views/homepage-3.jsp">Homepage #3</a></li>
                  </ul>
                </li>
                  ...
                  <div class="ps-cart__content">
                    <div class="ps-cart-item"><a class="ps-cart-item__close" href="#"></a>
                      ...
                      <div class="ps-cart-item__content"><a class="ps-cart-item__title"
                          href="../../views/product-detail.jsp">Amazinâ Glazinâ</a>
                    ...
                    <div class="ps-cart-item"><a class="ps-cart-item__close" href="#"></a>
                      ...
                      <div class="ps-cart-item__content"><a class="ps-cart-item__title" href="../../views/product-detail.jsp">The
                          Crusty Croissant</a>
                        <p><span>Quantity:<i>12</i></span><span>Total:<i>Â£176</i></span></p>
                      </div>
                    </div>
              ...
              <div class="col-lg-10 col-md-12 col-lg-offset-1">
                <div class="ps-product__thumbnail">
                  <div class="ps-product__preview">
                    <div class="ps-product__variants">
                      ...
                      href="http://www.youtube.com/watch?v=0O2aH4XLbto"><img src="../images/shoe-detail/1.jpg" alt=""><i
                ...
                <div class="ps-product__info">
                  ...
                  <p class="ps-product__category"><a href="#"> Men shoes</a>,<a href="#"> Nike</a>,<a href="#">
                      Jordan</a></p>
                  <h3 class="ps-product__price">Â£ 115 <del>Â£ 330</del></h3>
                  <div class="ps-product__block ps-product__quickview">
                    <h4>QUICK REVIEW</h4>
                    <p>The Nike Free RN 2017 Men's Running Sky weighs less than previous versions and features an
                      updated knit materialâ¦</p>
                  </div>
                  <div class="ps-product__block ps-product__style">
                    <h4>CHOOSE YOUR STYLE</h4>
                    <ul>
                      <li><a href="../../views/product-detail.jsp"><img src="../images/shoe/sidebar/1.jpg" alt=""></a></li>
                      <li><a href="../../views/product-detail.jsp"><img src="../images/shoe/sidebar/2.jpg" alt=""></a></li>
                      <li><a href="../../views/product-detail.jsp"><img src="../images/shoe/sidebar/3.jpg" alt=""></a></li>
                      <li><a href="../../views/product-detail.jsp"><img src="../images/shoe/sidebar/2.jpg" alt=""></a></li>
                    </ul>
                  </div>
                  ...
                  <div class="ps-product__shopping"><a class="ps-btn mb-10" href="cart.jsp">Add to cart<i
                        class="ps-icon-next"></i></a>
                    <div class="ps-product__actions"><a class="mr-10" href="whishlist.jsp"><i
                          class="ps-icon-heart"></i></a><a href="compare.jsp"><i class="ps-icon-share"></i></a></div>
                  </div>
                </div>
                ...
                <div class="tab-content mb-60">
                  <div class="tab-pane active" role="tabpanel" id="tab_01">
                    <p>Caramels tootsie roll carrot cake sugar plum. Sweet roll jelly bear claw liquorice. Gingerbread
                      lollipop dragÃ©e cake. Pie topping jelly-o. Fruitcake dragÃ©e candy canes tootsie roll. Pastry
                      jelly-o cupcake. Bonbon brownie soufflÃ© muffin.</p>
                    <p>Sweet roll soufflÃ© oat cake apple pie croissant. Pie gummi bears jujubes cake lemon drops gummi
                      bears croissant macaroon pie. Fruitcake tootsie roll chocolate cake Carrot cake cake bear claw
                      jujubes topping cake apple pie. Jujubes gummi bears soufflÃ© candy canes topping gummi bears cake
                      soufflÃ© cake. Cotton candy soufflÃ© sugar plum pastry sweet roll..</p>
                  </div>
                  <div class="tab-pane" role="tabpanel" id="tab_02">
                    ...
                    <div class="ps-review">
                      ...
                      <div class="ps-review__content">
                        ...
                        <p>SoufflÃ© danish gummi bears tart. Pie wafer icing. Gummies jelly beans powder. Chocolate bar
                          pudding macaroon candy canes chocolate apple pie chocolate cake. Sweet caramels sesame snaps
                          halvah bear claw wafer. Sweet roll soufflÃ© muffin topping muffin brownie. Tart bear claw cake
                          tiramisu chocolate bar gummies dragÃ©e lemon drops brownie.</p>
                      </div>
                    </div>
                  ...
                  <div class="ps-shoe">
                    <div class="ps-shoe__thumbnail">
                      ...
                      <div class="ps-badge ps-badge--sale ps-badge--2nd"><span>-35%</span></div><a
                        class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="../images/shoe/2.jpg"
              ...
              <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
                  <aside class="ps-widget--footer ps-widget--info">
                    <header><a class="ps-logo" href="../../views/index.jsp"><img src="images/logo-white.png" alt=""></a>
