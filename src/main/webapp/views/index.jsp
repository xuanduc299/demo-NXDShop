        ...
        <nav class="navigation">
          <div class="container-fluid">
            <div class="navigation__column left">
              <div class="header__logo"><a class="ps-logo" href="../../"><img src="../../images/logo.png"
                    alt=""></a></div>
            </div>
            <div class="navigation__column center">
              <ul class="main-menu menu">
                <li class="menu-item menu-item-has-children dropdown"><a href="../views/index.jsp">Home</a>
                  <ul class="sub-menu">
                    <li class="menu-item"><a href="../../views/index.jsp">Homepage #1</a></li>
                    <li class="menu-item"><a href="../../views/homepage-2.jsp">Homepage #2</a></li>
                    ...
                    <div class="mega-wrap">
                      <div class="mega-column">
                        <ul class="mega-item mega-features">
                          <li><a href="../../views/product-listing.jsp">NEW RELEASES</a></li>
                          <li><a href="../../views/product-listing.jsp">FEATURES SHOES</a></li>
                          <li><a href="../../views/product-listing.jsp">BEST SELLERS</a></li>
                          <li><a href="../../views/product-listing.jsp">NOW TRENDING</a></li>
                          <li><a href="../../views/product-listing.jsp">SUMMER ESSENTIALS</a></li>
                          <li><a href="../../views/product-listing.jsp">MOTHER'S DAY COLLECTION</a></li>
                          <li><a href="../../views/product-listing.jsp">FAN GEAR</a></li>
                        </ul>
                      </div>
                      <div class="mega-column">
                        <h4 class="mega-heading">Shoes</h4>
                        <ul class="mega-item">
                          <li><a href="../../views/product-listing.jsp">All Shoes</a></li>
                          <li><a href="../../views/product-listing.jsp">Running</a></li>
                          <li><a href="../../views/product-listing.jsp">Training & Gym</a></li>
                          <li><a href="../../views/product-listing.jsp">Basketball</a></li>
                          <li><a href="../../views/product-listing.jsp">Football</a></li>
                          <li><a href="../../views/product-listing.jsp">Soccer</a></li>
                          <li><a href="../../views/product-listing.jsp">Baseball</a></li>
                        </ul>
                      </div>
                      <div class="mega-column">
                        <h4 class="mega-heading">CLOTHING</h4>
                        <ul class="mega-item">
                          <li><a href="../../views/product-listing.jsp">Compression & Nike Pro</a></li>
                          <li><a href="../../views/product-listing.jsp">Tops & T-Shirts</a></li>
                          <li><a href="../../views/product-listing.jsp">Polos</a></li>
                          <li><a href="../../views/product-listing.jsp">Hoodies & Sweatshirts</a></li>
                          <li><a href="../../views/product-listing.jsp">Jackets & Vests</a></li>
                          <li><a href="../../views/product-listing.jsp">Pants & Tights</a></li>
                          <li><a href="../../views/product-listing.jsp">Shorts</a></li>
                        </ul>
                      </div>
                      <div class="mega-column">
                      ...
                      <div class="mega-column">
                        ...
                        <ul class="mega-item">
                          <li><a href="../../views/product-listing.jsp">NIKE</a></li>
                          <li><a href="../../views/product-listing.jsp">Adidas</a></li>
                          <li><a href="../../views/product-listing.jsp">Dior</a></li>
                          <li><a href="../../views/product-listing.jsp">B&G</a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
                ...
                <li class="menu-item menu-item-has-children dropdown"><a href="#">News</a>
                  <ul class="sub-menu">
                    <li class="menu-item menu-item-has-children dropdown"><a href="blog-grid.jsp">Blog-grid</a>
                      <ul class="sub-menu">
                        <li class="menu-item"><a href="../../views/blog-grid.jsp">Blog Grid 1</a></li>
                        <li class="menu-item"><a href="../../views/blog-grid-2.jsp">Blog Grid 2</a></li>
                      </ul>
                    </li>
                    <li class="menu-item"><a href="../../views/blog-list.jsp">Blog List</a></li>
                  </ul>
                </li>
                <li class="menu-item menu-item-has-children dropdown"><a href="#">Contact</a>
                  <ul class="sub-menu">
                    <li class="menu-item"><a href="../../views/contact-us.jsp">Contact Us #1</a></li>
                    <li class="menu-item"><a href="../../views/contact-us.jsp">Contact Us #2</a></li>
                  </ul>
                </li>
              </ul>
            </div>
            <div class="navigation__column right">
              ...
              <div class="ps-cart"><a class="ps-cart__toggle" href="#"><span><i>20</i></span><i
                ...
                <div class="ps-cart__listing">
                  ...
                  <div class="ps-cart__footer"><a class="ps-btn" href="../../views/cart.jsp">Check out<i
            ...
            <ul>
              <li class="ps-banner" data-index="rs-2972" data-transition="random" data-slotamount="default"
                data-hideafterloop="0" data-hideslideonmobile="off" data-rotate="0"><img class="rev-slidebg"
                  src="../images/slider/1248.jpg" alt="" data-bgposition="center center" data-bgfit="cover"
              ...
              <li class="ps-banner ps-banner--white" data-index="rs-100" data-transition="random"
                data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-rotate="0"><img
                  class="rev-slidebg" src="../images/slider/shoes-banner-01.jpg" alt="" data-bgposition="center center"
                      ...
                      <div class="ps-shoe mb-30">
                        <div class="ps-shoe__thumbnail">
                          ...
                          <div class="ps-badge ps-badge--sale ps-badge--2nd"><span>-35%</span></div><a
                            ...
                            src="../images/shoe/shoes-01.jpg" alt=""><a class="ps-shoe__overlay"
                            href="../../views/product-detail.jsp"></a>
                        </div>
                        <div class="ps-shoe__content">
                          <div class="ps-shoe__variants">
                            <div class="ps-shoe__variant normal"><img src="../images/shoe/shoes-01.jpg" alt=""><img
                                src="../images/shoe/shoes-03.jpg" alt=""><img src="../images/shoe/shoes-02.jpg" alt=""><img
                                src="../images/shoe/shoes-04.jpg" alt=""></div>
...
<!--                   product nike -->
                    ...
                    <div class="grid-item__content-wrapper">
                      <div class="ps-shoe mb-30">
                        <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i
                              class="ps-icon-heart"></i></a><img src="../images/shoe/shoes-02.jpg" alt=""><a
                            class="ps-shoe__overlay" href="../../views/product-detail.jsp"></a>
                        </div>
                        <div class="ps-shoe__content">
                          <div class="ps-shoe__variants">
                            <div class="ps-shoe__variant normal"><img src="../images/shoe/shoes-01.jpg" alt=""><img
                  ...
                  <div class="grid-item adidas">
                    <div class="grid-item__content-wrapper">
                      <div class="ps-shoe mb-30">
                        <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i
                              class="ps-icon-heart"></i></a><img src="../images/shoe/shoes-03.jpg" alt=""><a
                            class="ps-shoe__overlay" href="../../views/product-detail.jsp"></a>
                        </div>
                        <div class="ps-shoe__content">
                          <div class="ps-shoe__variants">
                            <div class="ps-shoe__variant normal"><img src="../images/shoe/shoes-01.jpg" alt=""><img
                                src="../images/shoe/shoes-04.jpg" alt=""><img src="../images/shoe/shoes-03.jpg" alt=""><img
                                src="../images/shoe/shoes-02.jpg" alt=""></div>
                            <select class="ps-rating ps-shoe__rating">
                              <option value="1">1</option>
                              <option value="1">2</option>
                              <option value="1">3</option>
                      ...
                      <div class="ps-shoe mb-30">
                        <div class="ps-shoe__thumbnail">
                          <div class="ps-badge ps-badge--sale"><span>-35%</span></div><a class="ps-shoe__favorite"
                            href="#"><i class="ps-icon-heart"></i></a><img src="../images/shoe/4.jpg" alt=""><a
                            class="ps-shoe__overlay" href="../../views/product-detail.jsp"></a>
                        </div>
                        <div class="ps-shoe__content">
                          <div class="ps-shoe__variants">
        ...
        <div class="ps-section--offer">
          <div class="ps-column"><a class="ps-offer" href="../../views/product-listing.jsp"><img
                src="../images/banner/1246.jpg" alt=""></a></div>
          <div class="ps-column"><a class="ps-offer" href="../../views/product-listing.jsp"><img
                src="../images/banner/banner-home-06.jpg" alt=""></a></div>
        </div>
                  ...
                  <div class="ps-shoe">
                    <div class="ps-shoe__thumbnail">
                      <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i
                          class="ps-icon-heart"></i></a><img src="../images/shoe/product_01.png" alt=""><a class="ps-shoe__overlay"
                        href="../../views/product-detail.jsp"></a>
                    </div>
                    <div class="ps-shoe__content">
                      <div class="ps-shoe__variants">
                      ...
                      <div class="ps-shoe__detail"><a class="ps-shoe__name" href="product-detai.jsp">Air Jordan 7
                          Retro</a>
                        <p class="ps-shoe__categories"><a href="#">Men shoes</a>,<a href="#"> Nike</a>,<a href="#">
                            Jordan</a></p><span class="ps-shoe__price"> £ 120</span>
                      </div>
                ...
                <div class="ps-shoes--carousel">
                  <div class="ps-shoe">
                    <div class="ps-shoe__thumbnail">
                      <div class="ps-badge"><span>New</span></div>
                      <div class="ps-badge ps-badge--sale ps-badge--2nd"><span>-35%</span></div><a
                        class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="../images/shoe/product_02.png"
                        alt=""><a class="ps-shoe__overlay" href="../../views/product-detail.jsp"></a>
                    </div>
                    <div class="ps-shoe__content">
                      <div class="ps-shoe__variants">
                        <div class="ps-shoe__variant normal"><img src="../images/shoe/2.jpg" alt=""><img
...
<!--                 product -->
                <div class="ps-shoes--carousel">
                  <div class="ps-shoe">
                    <div class="ps-shoe__thumbnail">
                      <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i
                          class="ps-icon-heart"></i></a><img src="../images/shoe/product_03.png" alt=""><a class="ps-shoe__overlay"
                        href="../../views/product-detail.jsp"></a>
                    </div>
                    <div class="ps-shoe__content">
                      <div class="ps-shoe__variants">
...
<!--                 product -->
                <div class="ps-shoes--carousel">
                  <div class="ps-shoe">
                    <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i
                          class="ps-icon-heart"></i></a><img src="../images/shoe/product_04.png" alt=""><a class="ps-shoe__overlay"
                        href="../../views/product-detail.jsp"></a>
                    </div>
                    <div class="ps-shoe__content">
                      <div class="ps-shoe__variants">
               ...
               <!--  product -->
                <div class="ps-shoes--carousel">
                  <div class="ps-shoe">
                    <div class="ps-shoe__thumbnail">
                      <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i
                          class="ps-icon-heart"></i></a><img src="../images/shoe/product_05.png" alt=""><a class="ps-shoe__overlay"
                        href="../../views/product-detail.jsp"></a>
                    </div>
                    <div class="ps-shoe__content">
                      <div class="ps-shoe__variants">
               ...
               <!--  product -->
                <div class="ps-shoes--carousel">
                  <div class="ps-shoe">
                    <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i
                          class="ps-icon-heart"></i></a><img src="../images/shoe/product_06.png" alt=""><a class="ps-shoe__overlay"
                        href="../../views/product-detail.jsp"></a>
                    </div>
                    <div class="ps-shoe__content">
                      <div class="ps-shoe__variants">
        ...
        <div class="ps-home-testimonial bg--parallax pb-80" data-background="../images/background/banner-home-08.jpg">
          <div class="container">
            ...
            <div class="ps-section__content">
              <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                  <div class="ps-post">
                    <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.jsp"></a><img
                        src="../images/blog/blog-01.jpg" alt=""></div>
                    <div class="ps-post__content"><a class="ps-post__title" href="blog-detail.jsp">An Inside Look at the
                        Breaking2 Kit</a>
                      <p class="ps-post__meta"><span>By:<a class="mr-5" href="blog.jsp">Alena Studio</a></span> -<span
                          class="ml-5">Jun 10, 2017</span></p>
                      <p>Leverage agile frameworks to provide a robust synopsis for high level overviews. Iterative
                        approaches to corporate strategy foster collaborative thinking to further…</p><a
                        class="ps-morelink" href="blog-detail.jsp">Read more<i class="fa fa-long-arrow-right"></i></a>
                    </div>
                  </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                  <div class="ps-post">
                    <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.jsp"></a><img
                        src="../images/blog/blog-02.jpg" alt=""></div>
                    <div class="ps-post__content"><a class="ps-post__title" href="blog-detail.jsp">Unpacking the
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                  <div class="ps-post">
                    <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.jsp"></a><img
                        src="../images/blog/blog-03.jpg" alt=""></div>
                    <div class="ps-post__content"><a class="ps-post__title" href="blog-detail.jsp">Nike’s Latest
        ...
        <div class="ps-home-contact">
          ...
          <div class="ps-home-contact__form">
            ...
            <footer>
              <form action="product-listing.jsp" action="/contacts" th:object="${contactRequest}" method="post">
                ...
                <div class="form-group text-center">
                  <button class="ps-btn" type="submit" >Send Message<i class="fa fa-angle-right"></i></button>
                </div>
              </form>
            </footer>
          </div>
