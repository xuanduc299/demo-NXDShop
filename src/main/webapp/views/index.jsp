...
<body class="ps-loading">
						...
						<div class="header__actions">
							...
							<div class="btn-group ps-dropdown">
								...
								<ul class="dropdown-menu">
									<li><a href="#"><img src="images/flag/usa.svg" alt="">
											USD</a></li>
									<li><a href="#"><img src="images/flag/singapore.svg"
											alt=""> SGD</a></li>
									<li><a href="#"><img src="images/flag/japan.svg"
											alt=""> JPN</a></li>
								</ul>
							</div>
							<div class="btn-group ps-dropdown">
				...
				<div class="navigation__column center">
					<ul class="main-menu menu">
						<li class="menu-item menu-item-has-children dropdown"><a
							href="../views/index.jsp">Home</a>
							<ul class="sub-menu">
								<li class="menu-item"><a href="../../views/index.jsp">Homepage
										#1</a></li>
								<li class="menu-item"><a href="../../views/homepage-2.jsp">Homepage
										#2</a></li>
								...
								<div class="mega-wrap">
									<div class="mega-column">
										<ul class="mega-item mega-features">
											<li><a href="../../views/product-listing.jsp">NEW
													RELEASES</a></li>
											<li><a href="../../views/product-listing.jsp">FEATURES
													SHOES</a></li>
											<li><a href="../../views/product-listing.jsp">BEST
													SELLERS</a></li>
											<li><a href="../../views/product-listing.jsp">NOW
													TRENDING</a></li>
											<li><a href="../../views/product-listing.jsp">SUMMER
													ESSENTIALS</a></li>
											<li><a href="../../views/product-listing.jsp">MOTHER'S
													DAY COLLECTION</a></li>
											<li><a href="../../views/product-listing.jsp">FAN
													GEAR</a></li>
										</ul>
									</div>
									<div class="mega-column">
										...
										<ul class="mega-item">
											<li><a href="../../views/product-listing.jsp">All
													Shoes</a></li>
											<li><a href="../../views/product-listing.jsp">Running</a></li>
											<li><a href="../../views/product-listing.jsp">Training
													& Gym</a></li>
									...
									<div class="mega-column">
										...
										<ul class="mega-item">
											<li><a href="../../views/product-listing.jsp">Compression
													& Nike Pro</a></li>
											<li><a href="../../views/product-listing.jsp">Tops &
													T-Shirts</a></li>
											<li><a href="../../views/product-listing.jsp">Polos</a></li>
											<li><a href="../../views/product-listing.jsp">Hoodies
													& Sweatshirts</a></li>
											<li><a href="../../views/product-listing.jsp">Jackets
													& Vests</a></li>
											<li><a href="../../views/product-listing.jsp">Pants
													& Tights</a></li>
						...
						<li class="menu-item menu-item-has-children dropdown"><a
							...
							<ul class="sub-menu">
								<li class="menu-item menu-item-has-children dropdown"><a
									href="blog-grid.jsp">Blog-grid</a>
									<ul class="sub-menu">
										<li class="menu-item"><a href="../../views/blog-grid.jsp">Blog
												Grid 1</a></li>
										<li class="menu-item"><a
											href="../../views/blog-grid-2.jsp">Blog Grid 2</a></li>
									</ul></li>
								<li class="menu-item"><a href="../../views/blog-list.jsp">Blog
										List</a></li>
							</ul></li>
						<li class="menu-item menu-item-has-children dropdown"><a
							href="#">Contact</a>
							<ul class="sub-menu">
								<li class="menu-item"><a href="../../views/contact-us.jsp">Contact
										Us #1</a></li>
								<li class="menu-item"><a href="../../views/contact-us.jsp">Contact
										Us #2</a></li>
							</ul></li>
					...
					<div class="ps-cart">
						...
						<div class="ps-cart__listing">
							...
							<div class="ps-cart__footer">
								<a class="ps-btn" href="../../views/cart.jsp">Check out<i
	...
	<div class="header-services">
		<div class="ps-services owl-slider" data-owl-auto="true"
			...
			<p class="ps-service">
				<i class="ps-icon-delivery"></i><strong>Free delivery</strong>: Get
				free standard delivery on every order with Sky Store
			</p>
			<p class="ps-service">
				<i class="ps-icon-delivery"></i><strong>Free delivery</strong>: Get
				free standard delivery on every order with Sky Store
	...
	<main class="ps-main">
			...
			<div class="rev_slider fullscreenbanner" id="home-banner">
				<ul>
					<li class="ps-banner" data-index="rs-2972" data-transition="random"
						...
						class="rev-slidebg" src="../images/slider/1248.jpg" alt=""
					...
					<li class="ps-banner ps-banner--white" data-index="rs-100"
						...
						src="../images/slider/shoes-banner-01.jpg" alt=""
						data-bgposition="center center" data-bgfit="cover"
						data-bgrepeat="no-repeat" data-bgparallax="5" data-no-retina>
		...
		<div
			...
			<div class="ps-container">
				...
				<div class="ps-section__content pb-50" id="ps-section__content grid">
									...
									<div class="ps-shoe mb-30">
										...
										<div class="ps-shoe__content">
											...
											<div class="ps-shoe__detail">
												...
												<button class="card__btn add-to-cart" data-id="6">Add
													to Cart</button>
											</div>
									...
									<div class="ps-shoe mb-30">
										...
										<div class="ps-shoe__content">
											...
											<div class="ps-shoe__detail">
												...
												<span class="ps-shoe__price"> $120</span>
												<button class="card__btn add-to-cart" data-id="7">Add
													to Cart</button>
											</div>
									...
									<div class="ps-shoe mb-30">
										...
										<div class="ps-shoe__content">
											...
											<div class="ps-shoe__detail">
												...
												<span class="ps-shoe__price"> $120</span>
												<button class="card__btn add-to-cart" data-id="8">Add
													to Cart</button>
											</div>
									...
									<div class="ps-shoe mb-30">
										...
										<div class="ps-shoe__content">
											...
											<div class="ps-shoe__detail">
												...
												<span class="ps-shoe__price"> $120</span>
												<button class="card__btn add-to-cart" data-id="9">Add
													to Cart</button>
											</div>
									...
									<div class="ps-shoe mb-30">
										...
										<div class="ps-shoe__content">
											...
											<div class="ps-shoe__detail">
												...
												<span class="ps-shoe__price"> $120</span>
												<button class="card__btn add-to-cart" data-id="10">Add
													to Cart</button>
											</div>
									...
									<div class="ps-shoe mb-30">
										...
										<div class="ps-shoe__content">
											...
											<div class="ps-shoe__detail">
												...
												<span class="ps-shoe__price"> $120</span>
												<button class="card__btn add-to-cart" data-id="5">Add
													to Cart</button>
											</div>
									...
									<div class="ps-shoe mb-30">
										...
										<div class="ps-shoe__content">
											...
											<div class="ps-shoe__detail">
												...
												<span class="ps-shoe__price"> $120</span>
												<button class="card__btn add-to-cart" data-id="4">Add
													to Cart</button>
											</div>
									...
									<div class="ps-shoe mb-30">
										...
										<div class="ps-shoe__content">
											...
											<div class="ps-shoe__detail">
												...
												<span class="ps-shoe__price"> $120</span>
												<button class="card__btn add-to-cart" data-id="3">Add
													to Cart</button>
											</div>
		...
		<div class="ps-section--offer">
			<div class="ps-column">
				<a class="ps-offer" href="../../views/product-listing.jsp"><img
					src="../images/banner/1246.jpg" alt=""></a>
			</div>
			<div class="ps-column">
				<a class="ps-offer" href="../../views/product-listing.jsp"><img
					src="../images/banner/banner-home-06.jpg" alt=""></a>
			</div>
		</div>
								...
								<a class="point first active" href="javascript:;"><i
									...
									<div class="ps-hotspot__content">
										...
										<p>Dynamic Fit Collar en la zona del tobillo que une la
											parte inferior de la pierna y el pie sin reducir la libertad
											de movimiento.</p>
									</div> </a><img src="../images/hot-deal.png" alt="">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="ps-section__header mb-50">
					<div class="row">
						<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 ">
							<h3 class="ps-section__title" data-mask="BEST SALE">- Top
								Sales</h3>
						</div>
							...
							<div class="ps-shoe">
								<div class="ps-shoe__thumbnail">
									...
									<a class="ps-shoe__favorite" href="#"><i
										...
										src="../images/shoe/product_01.png" alt=""><a
										class="ps-shoe__overlay" href="../../views/product-detail.jsp"></a>
								</div>
								<div class="ps-shoe__content">
									<div class="ps-shoe__variants">
										<div class="ps-shoe__variant normal">
											<img src="../images/shoe/2.jpg" alt=""><img
												src="../images/shoe/3.jpg" alt=""><img
												src="../images/shoe/4.jpg" alt=""><img
												src="../images/shoe/5.jpg" alt="">
										</div>
									...
									<div class="ps-shoe__detail">
										<a class="ps-shoe__name" href="product-detai.jsp">Air
											Jordan 7 Retro</a>
										<p class="ps-shoe__categories">
											<a href="#">Men shoes</a>,<a href="#"> Nike</a>,<a href="#">
												Jordan</a>
						...
						<div class="ps-shoes--carousel">
							<div class="ps-shoe">
								<div class="ps-shoe__thumbnail">
									...
									<a class="ps-shoe__favorite" href="#"><i
										class="ps-icon-heart"></i></a><img
										src="../images/shoe/product_02.png" alt=""><a
										class="ps-shoe__overlay" href="../../views/product-detail.jsp"></a>
								</div>
								<div class="ps-shoe__content">
									<div class="ps-shoe__variants">
						...
						<div class="ps-shoes--carousel">
							<div class="ps-shoe">
								<div class="ps-shoe__thumbnail">
									...
									<a class="ps-shoe__favorite" href="#"><i
										class="ps-icon-heart"></i></a><img
										src="../images/shoe/product_03.png" alt=""><a
										class="ps-shoe__overlay" href="../../views/product-detail.jsp"></a>
								</div>
								<div class="ps-shoe__content">
									<div class="ps-shoe__variants">
						...
						<div class="ps-shoes--carousel">
							<div class="ps-shoe">
								<div class="ps-shoe__thumbnail">
									<a class="ps-shoe__favorite" href="#"><i
										class="ps-icon-heart"></i></a><img
										src="../images/shoe/product_04.png" alt=""><a
										class="ps-shoe__overlay" href="../../views/product-detail.jsp"></a>
								</div>
								<div class="ps-shoe__content">
									<div class="ps-shoe__variants">
						...
						<div class="ps-shoes--carousel">
							<div class="ps-shoe">
								<div class="ps-shoe__thumbnail">
									...
									<a class="ps-shoe__favorite" href="#"><i
										class="ps-icon-heart"></i></a><img
										src="../images/shoe/product_05.png" alt=""><a
										class="ps-shoe__overlay" href="../../views/product-detail.jsp"></a>
								</div>
								<div class="ps-shoe__content">
									<div class="ps-shoe__variants">
						...
						<div class="ps-shoes--carousel">
							<div class="ps-shoe">
								<div class="ps-shoe__thumbnail">
									<a class="ps-shoe__favorite" href="#"><i
										class="ps-icon-heart"></i></a><img
										src="../images/shoe/product_06.png" alt=""><a
										class="ps-shoe__overlay" href="../../views/product-detail.jsp"></a>
								</div>
								<div class="ps-shoe__content">
									<div class="ps-shoe__variants">
		...
		<div class="ps-home-testimonial bg--parallax pb-80"
			data-background="../images/background/banner-home-08.jpg">
			<div class="container">
				<div class="owl-slider" data-owl-auto="true" data-owl-loop="true"
					...
					<div class="ps-testimonial">
						...
						<footer>
							<p>“Dessert pudding dessert jelly beans cupcake sweet
								caramels gingerbread. Fruitcake biscuit cheesecake. Cookie
								topping sweet muffin pudding tart bear claw sugar plum
								croissant. “</p>
						</footer>
					</div>
					<div class="ps-testimonial">
						<div class="ps-testimonial__thumbnail">
							<img src="../images/testimonial/2.jpg" alt=""><i
								class="fa fa-quote-left"></i>
						</div>
						<header>
							<select class="ps-rating">
					...
					<div class="ps-testimonial">
						<div class="ps-testimonial__thumbnail">
							<img src="../images/testimonial/3.jpg" alt=""><i
								class="fa fa-quote-left"></i>
						</div>
						<header>
							<select class="ps-rating">
					...
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
							<div class="ps-post">
								<div class="ps-post__thumbnail">
									<a class="ps-post__overlay" href="blog-detail.jsp"></a><img
										src="../images/blog/blog-01.jpg" alt="">
								</div>
								<div class="ps-post__content">
									<a class="ps-post__title" href="blog-detail.jsp">An Inside
										Look at the Breaking2 Kit</a>
									<p class="ps-post__meta">
										<span>By:<a class="mr-5" href="blog.jsp">Alena
									...
									<p>Leverage agile frameworks to provide a robust synopsis
										...
										strategy foster collaborative thinking to further…</p>
									<a class="ps-morelink" href="blog-detail.jsp">Read more<i
										class="fa fa-long-arrow-right"></i></a>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
							<div class="ps-post">
								<div class="ps-post__thumbnail">
									<a class="ps-post__overlay" href="blog-detail.jsp"></a><img
										src="../images/blog/blog-02.jpg" alt="">
								</div>
								<div class="ps-post__content">
									<a class="ps-post__title" href="blog-detail.jsp">Unpacking
						...
						<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
							<div class="ps-post">
								<div class="ps-post__thumbnail">
									<a class="ps-post__overlay" href="blog-detail.jsp"></a><img
										src="../images/blog/blog-03.jpg" alt="">
								</div>
								<div class="ps-post__content">
									<a class="ps-post__title" href="blog-detail.jsp">Nike’s
		...
		<div class="ps-home-contact">
			...
			<div class="ps-home-contact__form">
				<header>
					<h3>Contact Us</h3>
					<p>Learn about our company profile, communityimpact,
						sustainable motivation, and more.</p>
				</header>
				<footer>
					<form action="product-listing.jsp" action="/contacts"
						th:object="${contactRequest}" method="post">
						<div class="form-group">
							<label>Name<span>*</span></label> <input class="form-control"
								name="name" type="text">
						</div>
						<div class="form-group">
	...
	<script type="text/javascript"
		src="../../plugins/jquery/dist/jquery.min.js"></script>
	<script type="text/javascript"
	...
	<script type="text/javascript"
		src="../../plugins/jquery.matchHeight-min.js"></script>
	<script type="text/javascript"
		src="../../plugins/slick/slick/slick.min.js"></script>
	<script type="text/javascript"
