                ...
                <tbody>
                  <tr>
                    <td><a class="ps-product__preview" href="product-detail.jsp"><img class="mr-15"
                          src="images/product/cart-preview/1.jpg" alt=""> air jordan One mid</a></td>
                    <td>$150</td>
                    <td>
                  ...
                  <tr>
                    <td><a class="ps-product__preview" href="product-detail.jsp"><img class="mr-15"
                          src="images/product/cart-preview/2.jpg" alt=""> The Crusty Croissant</a></td>
                    <td>$150</td>
                    <td>
                      <div class="form-group--number">
                        <button class="minus"><span>-</span></button>
                  ...
                  <tr>
                    <td><a class="ps-product__preview" href="product-detail.jsp"><img class="mr-15"
                          src="images/product/cart-preview/3.jpg" alt="">The Rolling Pin</a></td>
                    <td>$150</td>
                    <td>
                      <div class="form-group--number">
                        <button class="minus"><span>-</span></button>
					...
					<div class="ps-cart__actions">
						...
						<div id="ps-cart__total" class="ps-cart__total">
							$0 <a class="ps-btn" href="checkout.jsp">Process to checkout<i
