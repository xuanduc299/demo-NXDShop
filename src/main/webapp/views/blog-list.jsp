          ...
          <div class="ps-container">
            <div class="row">
              <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 ">
                <div class="ps-post--2">
                  <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="#"></a><img src="images/blog/4.jpg"
                      alt=""></div>
                  <div class="ps-post__container">
                    <header class="ps-post__header"><a class="ps-post__title" href="blog-detail.jsp">Unpacking the
                        Breaking 2 Race Strategy</a>
                      <p>Posted by <a href="blog-grid.jsp">Alena Studio</a> on August 17, 2016 in <a
                    ...
                    <div class="ps-post__content">
                      <p>Leverage agile frameworks to provide a robust synopsis for high level overviews. Iterative
                        approaches to corporate strategy foster collaborative thinking to further, Support Sports Bra
                        has a compression fit and V-back straps that give you medium support and full range of motion
                        during your workoutâ¦.</p>
                    </div>
                    <footer class="ps-post__footer"><a class="ps-post__morelink" href="#">READ MORE<i
                ...
                <div class="ps-post--2">
                  <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="#"></a><img src="images/blog/5.jpg"
                      alt=""></div>
                  <div class="ps-post__container">
                    <header class="ps-post__header"><a class="ps-post__title" href="blog-detail.jsp">Leverage agile
                        frameworks to provide a robust synopsis</a>
                      <p>Posted by <a href="blog-grid.jsp">Alena Studio</a> on August 17, 2016 in <a
                          href="blog-grid.jsp">Men Shoes</a> , <a href="blog-grid.jsp">Stylish</a></p>
                    </header>
                    <div class="ps-post__content">
                ...
                <div class="ps-post--2">
                  <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="#"></a><img src="images/blog/3.jpg"
                      alt=""></div>
                  <div class="ps-post__container">
                    <header class="ps-post__header"><a class="ps-post__title" href="blog-detail.jsp">Nikeâs Latest
                ...
                <div class="ps-post--2">
                  <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="#"></a><img src="images/blog/4.jpg"
                      alt=""></div>
                  <div class="ps-post__container">
                    <header class="ps-post__header"><a class="ps-post__title" href="blog-detail.jsp">Breaking Down the
                        Black Rose Tech Fleece Collection</a>
                      <p>Posted by <a href="blog-grid.jsp">Alena Studio</a> on August 17, 2016 in <a
                          href="blog-grid.jsp">Men Shoes</a> , <a href="blog-grid.jsp">Stylish</a></p>
                    </header>
                    <div class="ps-post__content">
                ...
                <div class="ps-post--2">
                  <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="#"></a><img src="images/blog/5.jpg"
                      alt=""></div>
                  <div class="ps-post__container">
                    <header class="ps-post__header"><a class="ps-post__title" href="blog-detail.jsp">The Shoes Athletes
                        Say Will Change the Future of Running</a>
                      <p>Posted by <a href="blog-grid.jsp">Alena Studio</a> on August 17, 2016 in <a
                          href="blog-grid.jsp">Men Shoes</a> , <a href="blog-grid.jsp">Stylish</a></p>
                    </header>
                    <div class="ps-post__content">
