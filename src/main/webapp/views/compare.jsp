            ...
            <div class="ps-cart-listing ps-table--compare">
              <table class="table ps-cart__table">
                <tbody>
                  <tr>
                    <td>Product</td>
                    <td><a class="ps-product__preview text-uppercase" href="product-detail.jsp"><img class="mr-15"
                          src="images/product/cart-preview/3.jpg" alt=""> Air jordan One mid</a></td>
                    <td><a class="ps-product__preview text-uppercase" href="product-detail.jsp"><img class="mr-15"
                          src="images/product/cart-preview/3.jpg" alt=""> Air jordan One mid</a></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td>Order</td>
                    <td><a class="ps-btn" href="#">Add to cart<i class="ps-icon-next"></i></a><a
                        class="ps-product-favorite ml-10" href="whishlist.jsp"><i class="ps-icon-heart"></i></a></td>
                    <td><a class="ps-btn" href="#">Add to cart<i class="ps-icon-next"></i></a><a
                        class="ps-product-favorite ml-10" href="whishlist.jsp"><i class="ps-icon-heart"></i></a></td>
                  </tr>
                </tbody>
